...
const FormNavigation = ({ step, loading, handlePrevStep, handleNextStep, isLastStep }) => {
  return (
    <div className="mt-10 flex justify-center space-x-4">
      {step > 1 && (
        <button
          ...
          className="flex items-center px-6 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
        >
